...
BLACKLIST_GARDINO_WORDS = ['hanging basket', "random only","multiple orders"]

BLACKLIST_NSE_WORDS = ['certificate', 't-shirt', 'tote bag', 'nse tropicals', 'tetrasperma', 
...
GABRIELLA_SEARCH = [#"https://www.gabriellaplants.com/collections/popular/products/4-rhaphidophora-tetrasperma",
                    ...
                    "https://www.gabriellaplants.com/collections/growing/products/3-philodendron-gabby",
                    "https://www.gabriellaplants.com/products/3-gabby-philodendron-sport"]

ALOHA_SEARCH = [#"https://www.peaceofaloha.com/product-page/anthurium-regale",
                "https://www.peaceofaloha.com/product-page/variegated-frydek"]

USPT_SEARCH = [#"https://unsolicitedplanttalks.com/plants/p/jd8y7vfbjggp7tmw7kmbd0z7j13sl5",
                "https://unsolicitedplanttalks.com/plants/p/43ox13hah6ckuu9e2o99vaclz6zp03",
                "https://unsolicitedplanttalks.com/plants/p/hx8z321rys2val7jjuh0brhts13ax6"]